...
st.set_page_config(page_title= "Airbnb Data Visualization | By ramani",
                    page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Ramanistreamlit run  *!
...
client = pymongo.MongoClient("mongodb+srv://ramani:aaradhana@cluster0.z2koick.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
